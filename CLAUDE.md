...
! Current repo is `--repo lazyexplorer`

This project is indexed by GitNexus as **lazyexplorer** (158 symbols, 512 relationships, 20 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
